...
let txtCurso = document.querySelector("#txtCurso");
let txtPesquisar = document.querySelector("#txtPesquisar");
// BOTÕES
let btnCadastrar = document.querySelector("#btnCadastrar");
let btnLimpar = document.querySelector("#btnLimpar");
let btnOrdenar = document.querySelector("#btnOrdenar");
// TABELA
let tbAlunos = document.querySelector("#tbAlunos");
// CONTROLE DE EDIÇÃO
let posEditar = -1;
...
function cadastrarAluno() {
    ...
    let aluno = new Aluno(Number(txtId.value), txtNome.value, Number(txtIdade.value), txtCurso.value);
    alunos.push(aluno);
    localStorage.setItem("alunos", JSON.stringify(alunos));
    listarAlunos();
    limparCampos();
